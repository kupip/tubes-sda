...
void print_menu_utama() {
  ...
  kursor(kolom, ++baris);
  printf("\xBA 2. Tampil Daftar Pasien            \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 3. Tampil Antrean Pasien           \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 4. Proses antrean (panggil pasien) \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 5. Hapus Pasien                    \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 6. Ubah Bobot Master               \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 7. Panduan                         \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 8. Kredit                          \xBA");
  kursor(kolom, ++baris);
  printf("\xBA 9. Quit                            \xBA");
  kursor(kolom, ++baris);
